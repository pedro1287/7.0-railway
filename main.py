    ...
    try:
        ...
        if '/start' in msgText:
            ...
            #    
                # set in debug
            #    api_id = 22706248
            #    api_hash = '4becb8cc8e4c2cc40c0e9e5a501aad82'
            #    bot_token = '5338774616:AAFkvKw46yzBJLKR0_ZZ0Vd2MK6iUsZ9lek'
...
def main():
    ...
    #set
    bot_token = '5912995927:AAFNs_4ERKfEgiMlf6c8ufWbdcn3cI_g1Oo'
